...
function Update()
    ...
    text('Adapter', result.identity and (input.alias ~= '' and input.alias or input.description)
        or ('Selected: ' .. input.selector))
    option('Adapter', 'ToolTipText', Core.safe('Selector: ' .. input.selector .. '\n'
        .. (result.identity and (input.alias .. ' / ' .. input.description) or 'No verified matching adapter')
        .. '\nClick for Connection information. Edit Network settings in the context menu.'))
